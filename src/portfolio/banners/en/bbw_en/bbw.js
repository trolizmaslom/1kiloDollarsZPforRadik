...
(lib.Символ27 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(68.7,10.3);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,137.3,20.5);
...
(lib.Символ26 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFF33").s().p("");
	this.shape.setTransform(68.7,10.3);
...
(lib.Символ24 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(68.7,10.2,1,1,0,0,0,68.7,10.2);
	...
	this.instance_1.setTransform(68.7,10.2,1,1,0,0,0,68.7,10.2);
...
(lib.Символ20 = function() {
	...
	this.instance.setTransform(107.9,42.9,1,1,0,0,0,68.7,10.2);
