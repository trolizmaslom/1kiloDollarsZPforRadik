...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images_casinox_bbw_bonus_rus/backg.jpg", id:"backg"},
		{src:"images_casinox_bbw_bonus_rus/bbw.png", id:"bbw"},
		{src:"images_casinox_bbw_bonus_rus/bt.png", id:"bt"},
		{src:"images_casinox_bbw_bonus_rus/ear.png", id:"ear"},
		{src:"images_casinox_bbw_bonus_rus/hand.png", id:"hand"},
		{src:"images_casinox_bbw_bonus_rus/k1.jpg", id:"k1"},
		{src:"images_casinox_bbw_bonus_rus/logo.png", id:"logo"},
		{src:"images_casinox_bbw_bonus_rus/pig1.png", id:"pig1"},
		{src:"images_casinox_bbw_bonus_rus/pig2.png", id:"pig2"},
		{src:"images_casinox_bbw_bonus_rus/s1.png", id:"s1"},
		{src:"images_casinox_bbw_bonus_rus/sxsx3.png", id:"sxsx3"},
		{src:"images_casinox_bbw_bonus_rus/trava.png", id:"trava"}
	]
};
...
(lib.Символ21 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AghDZQgNgOAAgUQAAgTANgOQAOgOATAAQATAAAPAOQANANAAAUQAAAVgNANQgPAOgTAAQgTAAgOgOgAgaBjIAAlJIA0AAIAAFJg");
	this.shape.setTransform(409.2,-0.8);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AhJDCQgogOgegcQgdgbgQgnQgSgnABgvQgBguASgoQARgnAdgbQAegbAogOQAngOAuAAQBAAAAxAYQAxAYAfAtIgtAbQgZgiglgRQgjgRg1AAQgkAAgcALQgfALgUAUQgVAVgMAdQgMAdAAAiQAAAiAMAcQAMAeAVAVQAYAVAcALQAdAMAiAAQA1AAAjgSQAkgSAagiIAuAbQggAtgvAZQgwAYhDAAQgtAAgpgOg");
	this.shape_1.setTransform(371.1,1.7);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AhgDGIAAgxIBgAAQASAAAQgJQARgJAHgUIAQgvIh0AAQglAAgcgUQgcgWgMgiIhDi5IA7AAIA/CvQAGASAPAHQAPAJATAAIB+AAIBFjRIA5AAIhpE9QgLAjgdAWQgcAWgngBg");
	this.shape_2.setTransform(319.6,1.7);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("ACODGIAAi0IkcAAIAAC0Ig4AAIAAmLIA4AAIAAClIEcAAIAAilIA5AAIAAGLg");
	this.shape_3.setTransform(265,1.7);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("");
	this.shape_4.setTransform(208.7,1.7);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AjADGIAAmLIFNAAIAAAzIkVAAIAABcIDBAAQAdAAAZAJQAYAIASARQATAQALAWQAKAXAAAcQAAAcgKAWQgLAZgTARQgRAQgZAMQgaAKgcgBgAiICSIC6AAQAtAAAUgVQAVgYAAggQAAghgVgUQgVgUgtAAIi5AAg");
	this.shape_5.setTransform(154.7,1.7);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("Ai0DGIAAmLIFeAAIAAAyIklAAIAAB2IEHAAIAAAxIkHAAIAAB+IEwAAIAAA0g");
	this.shape_6.setTransform(72.4,1.7);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("ADADwIgGhTIlyAAIgGBTIgvAAIAAiHIA1AAIBIlYIEtAAIAAFYIAxAAIAACHgAh8BpIEAAAIAAkmIjGAAg");
	this.shape_7.setTransform(16.8,5.8);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AiyDGIAAmLIFkAAIAAAzIkrAAIAAFYg");
	this.shape_8.setTransform(-31.5,1.7);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("ACTEAIAAlAIkjFAIg6AAIAAmLIA4AAIAAFCIEjlCIA6AAIAAGLgAg6i5QgbgNgXgeIAfgbQAPARAUAKQATAKAXAAQAWAAAUgKQAUgKAPgRIAfAbQgXAdgbAOQgbAMgfAAQggAAgagMg");
	this.shape_9.setTransform(-115.2,-4.1);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("ACxDGIgchAIkoAAIgcBAIg8AAICumLICAAAICpGLgAh9BSID6AAIhfjlIg5AAg");
	this.shape_10.setTransform(-173.2,1.7);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AC/DwIgFhTIlyAAIgGBTIgvAAIAAiHIA0AAIBJlYIEsAAIAAFYIAyAAIAACHgAh8BpIEAAAIAAkmIjHAAg");
	this.shape_11.setTransform(-232.9,5.8);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("ACxDGIgchAIkoAAIgcBAIg8AAICumLIB/AAICqGLgAh9BSID6AAIhfjlIg5AAg");
	this.shape_12.setTransform(-292.6,1.7);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AixDGIAAmLIFjAAIAAAzIkrAAIAAFYg");
	this.shape_13.setTransform(-339.7,1.7);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AhhDGIAAgxIBhAAQARAAARgJQAQgIAIgVIAQgvIh0AAQgmAAgbgUQgcgVgNgjIhCi5IA6AAIBACvQAGASAPAHQAPAJASAAIB/AAIBFjRIA5AAIhqE9QgLAjgcAWQgcAWgngBg");
	this.shape_14.setTransform(-392.4,1.7);
...
p.nominalBounds = new cjs.Rectangle(-413.9,-29.8,827.9,59.7);
...
(lib.Символ11 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgbDGIAAlYIiwAAIAAg0IGXAAIAAA0IiwAAIAAFYg");
	this.shape.setTransform(53.4,0);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AhgDGIAAgxIBgAAQASAAAQgJQARgIAHgUIAQgwIh0AAQglABgcgWQgcgVgMgiIhDi6IA7AAIA/CwQAGARAPAJQAPAIATABIB+AAIBFjTIA5AAIhpE/QgLAigdAWQgcAWgngBg");

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgbDGIAAlYIiwAAIAAg0IGXAAIAAA0IiwAAIAAFYg");
	this.shape_2.setTransform(-53.3,0);

	this.addChild(this.shape_2,this.shape_1,this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-73.8,-19.9,147.6,39.8);
...
(lib.casinox_bbw_bonus_rus = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
