...
(lib._3 = function() {
	this.spriteSheet = ss["gonzo_vul640_305_atlas_"];
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib._333498531 = function() {
	this.spriteSheet = ss["gonzo_vul640_305_atlas_"];
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
...
(lib.GonzosQuestStanding = function() {
	this.spriteSheet = ss["gonzo_vul640_305_atlas_"];
	this.gotoAndStop(3);
}).prototype = p = new cjs.Sprite();
...
p.nominalBounds = new cjs.Rectangle(0,0,104.4,71);
...
(lib.Символ66 = function() {
	...
	this.instance.setTransform(0,53.3);

	this.addChild(this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,53.3,412,416);
...
(lib.Символ61 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["gonzo_vul640_305_atlas_"],1), null, new cjs.Matrix2D(1,0,0,1,-203.4,-196)).s().p("");
...
(lib.Символ57 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["gonzo_vul640_305_atlas_"],2), null, new cjs.Matrix2D(1,0,0,1,-400,-257)).s().p("A8bDzIAAnmMA42AAAIAAHmg");
...
(lib.Символ53 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["gonzo_vul640_305_atlas_"],2), null, new cjs.Matrix2D(1,0,0,1,-595.4,-427.6)).s().p("ADYDUIAdAAIARAPQgXgGgXgJgABBCDQhDgThLACIhQABIhoA4IAHhQIAWABIAUgUQAygWDLibQBdhGA5gvIA2gEIggCwQgsAogIA9IgMBhIApA1QhAgbg9grg");
	this.shape.setTransform(26.3,22.8);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,52.5,45.6);
...
(lib.Символ52 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["gonzo_vul640_305_atlas_"],2), null, new cjs.Matrix2D(1,0,0,1,-523.4,-412.3)).s().p("");
	this.shape.setTransform(59.8,48.4);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,119.6,96.8);
...
(lib.Символ51 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["gonzo_vul640_305_atlas_"],2), null, new cjs.Matrix2D(1,0,0,1,-431.6,-433.2)).s().p("AkUFzIgChZIAMgYQBOieANhTQATh8BlibIAEgHQBHg4BHguQABAlgEAjQgLBtgaBrIBABAIA4AWIAIAYQAIAAAHADIADADQAKAKAMAIIAoBAIAPAFIAFCbQjtBhkCAAIg8gBg");
	this.shape.setTransform(27.9,37.2);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,55.9,74.5);
...
(lib.Символ46 = function() {
	...
	this.instance.setTransform(19.7,9.6);

	this.shape = new cjs.Shape();
	this.shape.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["gonzo_vul640_305_atlas_"],1), null, new cjs.Matrix2D(1,0,0,1,-145,-374)).s().p("AAAAEIgIgHIAQAHg");
	this.shape.setTransform(145,374);

	this.addChild(this.shape,this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(19.7,9.6,367,373);
...
p.nominalBounds = new cjs.Rectangle(-0.8,0,801,514);
...
(lib.Символ38 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["gonzo_vul640_305_atlas_"],4), null, new cjs.Matrix2D(1,0,0,1,-31.6,-42)).s().p("");
...
(lib.Символ37 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["gonzo_vul640_305_atlas_"],4), null, new cjs.Matrix2D(1,0,0,1,-29,-65.7)).s().p("");
...
(lib.Символ36 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["gonzo_vul640_305_atlas_"],4), null, new cjs.Matrix2D(1,0,0,1,-53.5,-50.9)).s().p("");
...
(lib.Символ35 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["gonzo_vul640_305_atlas_"],4), null, new cjs.Matrix2D(1,0,0,1,-49.3,-20.9)).s().p("AhhCIIAPgUIgFgoIhGgZIAOgLQAXgYAmgFQADgIAEgEQAFgGAIgFQgegOgagQIAbhCQBDgEA8gZIB6AJQgfA2gjA1IgBAEQADAJARgEQAMgDAMgEQAGgBAFgCQgWA1ghAyIgZAAQg0A5hLAAQgRAAgTgCg");
...
(lib.Символ34 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["gonzo_vul640_305_atlas_"],4), null, new cjs.Matrix2D(1,0,0,1,-28,-20.5)).s().p("AghCRIhjgtQASgUAagPQgbgSgNgWIAZgFQADgPgmgiQAiAFAagZIgFgZIAEgBQAegUAkgJIgggSIAbgbIAKAAQAFAAADgBQACgEADgFICGAGQgzCMhHCBQgCADAAAGQAAAFABABQALADANABQAFgBAEgBIACAAIgfAWIgcAAIgKAFg");
...
(lib.Символ33 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["gonzo_vul640_305_atlas_"],4), null, new cjs.Matrix2D(1,0,0,1,-72.4,-21.4)).s().p("AiUDDIAEgUIAUgPQAYgRABgcIgKgFIg3AAQAzhBAehJQgFADgGABQgMAEgNACQgQAFgDgKIABgEQAqhAAlhDIBMg3IB0AAQARAWAOAXIAAEjIgDACIgDAAIgGAHQgsAfgyAPQgFACgEAAQgbgSgHgfQgBgGgGgFQgmAqgXA0Qg1gBgrgSg");
...
(lib.Символ32 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["gonzo_vul640_305_atlas_"],4), null, new cjs.Matrix2D(1,0,0,1,-73.9,-53)).s().p("Ah3BmIgEgMIgagVIAGgUQAYg1AZhGQAFAAABABIAEAUQAWhQA6g9QAEAFABAGQAHAfAbATQAFAAAEgDQA4gRAxgmIAAF9Qg/gigyg1IgMgNIgUgPQgNAqARBEQABAEABAFQg5gmhIg2g");
...
(lib.Символ31 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["gonzo_vul640_305_atlas_"],4), null, new cjs.Matrix2D(1,0,0,1,-70.1,-76.3)).s().p("AAYCdQgKgDgLgCQgsgJgogRQgBgwgSg4Ig3AjQgKgygWgoIBXgDQASgTgIgbQgIgfAIgSQAFAAADACQBJA2A5AnQAAgFgBgFQgUhEAQgqIAUAPIALAOQAzA0A/AiIAADGg");
...
(lib.Символ30 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["gonzo_vul640_305_atlas_"],4), null, new cjs.Matrix2D(1,0,0,1,-42.5,-77.3)).s().p("Ai7CTIgFgZQAbgaAUggQACgCADAAIgMAAQA6gpArg2QAFgGADgHQAjgWAJgmQAHgXAQgRIAFBaQAJANAPgdIAGgOQAtA6APBLIA3gjQAYBKgGA9g");
...
(lib.Символ29 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["gonzo_vul640_305_atlas_"],4), null, new cjs.Matrix2D(1,0,0,1,-14.2,-76.4)).s().p("AhwCcQgQgNgMgQIAAjWIAFgKIAFgDIAAAHIAtgKIAPgUQAFgCAFgBIAEgDIACgEIAEgJIAjgNIAAACIAFALIANAPIAAByIAJgFQADgCACgDQADgEAEgDQAGgDAIAAIAABFIgBAEIgHAMQgCADAAAGIAAAOIBxgEQgDAAgCACQgeAwgwAjg");
...
(lib.Символ28 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["gonzo_vul640_305_atlas_"],4), null, new cjs.Matrix2D(1,0,0,1,-13.2,-48.8)).s().p("Ah+gfIBFhfQAOAfARAdQgChFApguIBjAtIAPAPQgJASgXAMQgxAagOAnQAJAQAjAEQAJAAAGAGIABACQgGAXgSASQgXAWgXAHIAQAJIADACQAGAEAEAGIABAEIhdAjIgEAKIgCAEIgDACQgGABgFADIgPAUIgtAKg");
...
(lib.Символ27 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["gonzo_vul640_305_atlas_"],4), null, new cjs.Matrix2D(1,0,0,1,-14.4,-21.5)).s().p("Ah2iBQAkgqAsghICeBaQgjAJgeAUIgFABIAFAZQgZAZghgFQAlAkgEANIgZAEQAOAYAaARQhVA0ACBiQhbiXALi3g");
...
(lib.Символ24 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["gonzo_vul640_305_atlas_"],4), null, new cjs.Matrix2D(1,0,0,1,-134,-46)).s().p("AnBHMIAAuXIODAAIAAOXg");
...
(lib.Символ22 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["gonzo_vul640_305_atlas_"],4), null, new cjs.Matrix2D(1,0,0,1,-44.5,-138.5)).s().p("Am7HQIAAufIN3AAIAAOfg");
...
(lib.Символ21 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["gonzo_vul640_305_atlas_"],4), null, new cjs.Matrix2D(1,0,0,1,-44.5,-46)).s().p("Am7HMIAAuXIN3AAIAAOXg");
...
(lib.Символ18 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["gonzo_vul640_305_atlas_"],3), null, new cjs.Matrix2D(0.541,0,0,0.541,-103.1,-75.3)).s().p("AAWByQgBgHgIACIgKAFIgaAAQgSgMgVAAIgpgSIgbAAIgSgMIgCgPIgCgBQgEgEgCgIQAAgMgVggIAYgPQAYAIAJgOQgfhqBsAcIACAJQgCghA1AJIAyAAIBIASQAeBSAVBRIgIACIgIAPQgNAMgPAIIgJglQgLAAgIADQggANgUAiQgTgEgQABg");
	this.shape.setTransform(15.9,11.5);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-2.2,-0.2,36.2,23.5);
...
(lib.Символ13 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["gonzo_vul640_305_atlas_"],3), null, new cjs.Matrix2D(0.541,0,0,0.541,-34.9,-201.8)).s().p("AlcFjIAAlkIBAhDQAighATgsIAEgKIAdASQAyg8BGgyIAyhaQAUAEAIgUQA7gFBHAaIAFAPQANAFANAEQAjAKAngEIBfAtIAAFNQAfA/gUBDQgcBYgqA9g");
	this.shape.setTransform(34.9,35.5);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,69.9,71.1);
...
(lib.Символ12 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["gonzo_vul640_305_atlas_"],3), null, new cjs.Matrix2D(0.541,0,0,0.541,-123.7,-198.7)).s().p("AkrGCIgBgCQgPgVgRgTQjvkFB5kvQBagoBVgeIAFgPIAygPIAPgPQAlgCAhgNIAKgPIAjgUIECD6QAkAoAiAtQBQA0BGBGQCCCAghC5IAAABg");
	this.shape.setTransform(49.2,38.7);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,98.5,77.4);
...
(lib.Символ11 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["gonzo_vul640_305_atlas_"],3), null, new cjs.Matrix2D(0.541,0,0,0.541,-22.5,-147.7)).s().p("AjgEgIAAn2QAUAGAIASQADAEAJAAQAoAEAPgaQAFgJgKgdIAogUIBGgKQAYABADAUIACAJIBdAAIAHAKIAKAyQAZAPAEAjQAFAlAkgHIAKA8QABAXASAIQAGAEAFAFQgJAcgbAYQgRARgSAdIgKA8IgTAeQgJAZgVgFIgyBaQhFAygxA8QhWgwhBhCgAjgmRIAEAAIgEAUg");
	this.shape.setTransform(22.5,40.3);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,45,80.5);
...
(lib.Символ10 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["gonzo_vul640_305_atlas_"],3), null, new cjs.Matrix2D(0.541,0,0,0.541,-22,-107.8)).s().p("AiyDTQgKAAgCgDQgJgTgTgGIAAinQAJgyALg0QAKgFAGgIQBLhqBngGIgEAtIAmAUIAoA8IAeAKQAAAKAFAGQASAZAbATIAeBXQAGgfAhgMQgDAqgGApIgoAoIigAAIgBgJQgEgUgXgBIhGAKIgoAUQAJAdgFAJQgMAXggAAIgKgBg");
...
(lib.Символ9 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["gonzo_vul640_305_atlas_"],3), null, new cjs.Matrix2D(0.541,0,0,0.541,-35.2,-94.8)).s().p("AASBwQgZgTgSgZQgFgGAAgKIgegKIgog6IgogUIAKhkIA8g8IB2AAQBHgYANBnQABAGAFAFQALCLgeBtQgBAFAAAFQg+AFgIAsg");
	this.shape.setTransform(14.2,20.2);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,28.3,40.4);
...
(lib.Символ7 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["gonzo_vul640_305_atlas_"],3), null, new cjs.Matrix2D(0.541,0,0,0.541,-77.7,-26)).s().p("An6C+QhAg+gkhiQgPigCbg6QA3gnA6gfIN5AAQANATANAVIAeAKQA3DQh9CgIgoAUIhugUQhDAchKAUQgEACgFAAQiWAxikAAQjEAAjahFg");
	this.shape.setTransform(60.9,26);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,121.8,52);
...
(lib.Символ6 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["gonzo_vul640_305_atlas_"],3), null, new cjs.Matrix2D(0.541,0,0,0.541,-108.4,-105.6)).s().p("AAiDVIhNgeQgKhGgigvQgCgDgFAAIAAjGIAegoQAXgTAtAJQAUghAggNQAIgEALAAIATBQIAAAwIgHAGQgCABAAAFIgKCUIgzBaIAKAoIApAUIAKADIAAAbQgNADgKAAQgZAAgDgXg");
	this.shape.setTransform(9.5,23.6);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,19,47.3);
...
(lib.Символ5 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["gonzo_vul640_305_atlas_"],3), null, new cjs.Matrix2D(0.541,0,0,0.541,-129.1,-109.3)).s().p("AiCCmIgogUIgKgoIAyhZIAKiUQAAgFACgCQAhgYAPgdICoAuIAAB8QAgAiAHBKIABATIArAMQg2AMgTA4QgmAGgnAAQhPAAhSgag");
	this.shape.setTransform(18.2,19.3);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,36.4,38.5);
...
(lib.Символ4 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["gonzo_vul640_305_atlas_"],3), null, new cjs.Matrix2D(0.541,0,0,0.541,-168.1,-96.5)).s().p("Aj6DqIgBgTQgHhKgggkIAAjQIBGiCIBugyIAIAAIgIAUIAeAyQAlAZAWAjIALAUIB2AKQA2gXAlgpIBZBKQAVDUiXCbIgyAAIgeAeQixgHiXgrg");
	this.shape.setTransform(29.1,28.5);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,58.3,57);
...
(lib.Символ2 = function() {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["gonzo_vul640_305_atlas_"],3), null, new cjs.Matrix2D(0.541,0,0,0.541,-178.1,-59)).s().p("AhuDvIgLgTQgWgkglgYIgegyIAehRIAegdIAKhFQAFAAACgCQAngrAEg2IBshRIBQAAQBIApAmBFQAQCXhMBYQgmBqhmAsg");
	this.shape.setTransform(21.1,25);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,42.3,50);
...
(lib.Символ55 = function(mode,startPosition,loop) {
	...
	// Слой 5
	this.text = new cjs.Text("ПОЛУЧИТЬ БОНУС х2", "bold 17px 'Intro Bold Caps'", "#FFFFFF");
	this.text.textAlign = "center";
	this.text.lineHeight = 19;
	this.text.setTransform(186.7,18.3,1.445,1.445);
	this.text.shadow = new cjs.Shadow("rgba(255,0,0,1)",0,0,11);

	this.timeline.addTween(cjs.Tween.get(this.text).wait(1).to({y:17.4,color:NaN},0).wait(1));
...
(lib.Символ50 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(26.2,22.8,1,1,0,0,0,26.2,22.8);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleY:1.01,skewX:4,x:27.9},13,cjs.Ease.get(-1)).to({scaleY:1.01,skewX:10,x:30.2},18,cjs.Ease.get(1)).to({scaleY:1.01,skewX:5,x:28.3},14,cjs.Ease.get(-1)).to({scaleY:1,skewX:0,x:26.2},15,cjs.Ease.get(1)).wait(1));
...
(lib.Символ49 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(27.9,37.2,1,1,0,0,0,27.9,37.2);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleY:1,skewX:2.8,x:29.8},9,cjs.Ease.get(-1)).to({scaleY:1.01,skewX:6.1,x:31.9},10,cjs.Ease.get(1)).to({scaleY:1,skewX:2.8,x:29.9},17,cjs.Ease.get(-1)).to({scaleY:1,skewX:0,x:27.9},16,cjs.Ease.get(1)).wait(1));
...
(lib.Символ48 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(59.8,48.4,1,1,0,0,0,59.8,48.4);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleY:1,skewX:-3.8,x:56.5,y:49.1},14,cjs.Ease.get(-1)).to({scaleY:1.01,skewX:-8,x:53,y:50},15,cjs.Ease.get(1)).to({regX:59.7,scaleY:1,skewX:-3.8,x:56.4,y:49.2},18,cjs.Ease.get(-1)).to({regX:59.8,scaleY:1,skewX:0,x:59.8,y:48.4},18,cjs.Ease.get(1)).wait(1));
...
(lib.Символ47 = function() {
	...
	this.instance.setTransform(215,63.7,1,1,0,0,0,26.2,22.8);

	this.instance_1 = new lib.Символ49();
	this.instance_1.setTransform(51.3,69.3,1,1,0,0,0,27.9,37.2);

	this.instance_2 = new lib.Символ48();
	this.instance_2.setTransform(83.3,0);

	this.shape = new cjs.Shape();
	this.shape.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["gonzo_vul640_305_atlas_"],2), null, new cjs.Matrix2D(1,0,0,1,-542.1,-470.9)).s().p("");
	this.shape.setTransform(161.8,107);
...
(lib.Символ40 = function(mode,startPosition,loop) {
	...
	// Слой 6
	this.text = new cjs.Text("Блики по контуру", "bold 38px 'Arial Black'", "#FFCC00");
...
(lib.Символ26 = function(mode,startPosition,loop) {
	...
	// Слой 23
	this.text = new cjs.Text("Взрыв", "bold 38px 'Arial Black'", "#FFCC00");
	this.text.lineHeight = 40;
...
(lib.Символ25 = function(mode,startPosition,loop) {
	...
	this.instance_6.setTransform(44.5,-72.4,1,1,0,0,0,44.5,46.5);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(2).to({_off:false},0).to({y:215.8},9,cjs.Ease.get(-1)).to({rotation:-6.2,y:211.7},3).to({rotation:0,y:214.8},2).wait(118).to({regY:46.4,rotation:24.9,y:398.8},10,cjs.Ease.get(-1)).to({_off:true},1).wait(20));

	// Символ 21
	this.instance_7 = new lib.Символ21();
	this.instance_7.setTransform(124,-80.5,1,1,0,0,0,44.5,46);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(4).to({_off:false},0).to({y:207.8},9,cjs.Ease.get(-1)).to({regY:46.1,rotation:5.5,y:203.9},3).to({regY:46,rotation:0,y:206.8},2).wait(112).to({rotation:-11.2,y:390.8},10,cjs.Ease.get(-1)).to({_off:true},1).wait(24));

	// Символ 24
	this.instance_8 = new lib.Символ24();
	this.instance_8.setTransform(367.9,-81.1,1,1,-1.4,0,0,45,46);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(15).to({_off:false},0).to({y:127.9},9,cjs.Ease.get(-1)).to({rotation:2.8,y:124},3).to({rotation:-1.4,y:126.9},2).wait(109).to({regX:45.1,rotation:25.8,x:361,y:369},10,cjs.Ease.get(-1)).to({_off:true},1).wait(16));

	// Символ 24
	this.instance_9 = new lib.Символ24();
	this.instance_9.setTransform(53.2,-82.1,1,1,-1.4,0,0,45,46);
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(20).to({_off:false},0).to({y:126.9},9,cjs.Ease.get(-1)).to({rotation:1,y:122.9},3).to({rotation:-1.4,y:125.9},2).wait(107).to({rotation:30.5,x:46.2,y:368},10,cjs.Ease.get(-1)).to({_off:true},1).wait(13));

	// Символ 24
	this.instance_10 = new lib.Символ21();
	this.instance_10.setTransform(281.3,-80,1,1,0,0,0,44.5,46);
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(18).to({_off:false},0).to({y:129},9,cjs.Ease.get(-1)).to({rotation:-3.7,y:125},3).to({rotation:0,y:128},2).wait(22).to({_off:true},1).wait(110));

	// Символ 21
	this.instance_11 = new lib.Символ22();
	this.instance_11.setTransform(122.8,-71.9,1,1,0,0,0,44.5,46.5);
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(22).to({_off:false},0).to({y:137.1},9,cjs.Ease.get(-1)).to({rotation:-3.7,y:133.1},3).to({rotation:0,y:136.1},2).wait(104).to({rotation:-18.7,x:115.8,y:378.1},10,cjs.Ease.get(-1)).to({_off:true},1).wait(14));

	// Символ 22
	this.instance_12 = new lib.Символ21();
	this.instance_12.setTransform(202.2,-80,1,1,0,0,0,44.5,46);
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(14).to({_off:false},0).to({y:129},9,cjs.Ease.get(-1)).to({rotation:4.7,y:125.1},3).to({rotation:0,y:128},2).wait(115).to({rotation:-33.7,x:195.2,y:370.1},10,cjs.Ease.get(-1)).to({_off:true},1).wait(11));

	// Символ 24
	this.instance_13 = new lib.Символ24();
	this.instance_13.setTransform(367.9,-84.8,1,1,-1.4,0,0,45,46);
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(34).to({_off:false},0).to({y:48.2},9,cjs.Ease.get(-1)).to({regX:45.1,rotation:-4.4,x:368,y:44.1},3).to({regX:45,rotation:-1.4,x:367.9,y:47.2},2).wait(99).to({regY:46.1,rotation:35.5,y:361.3},10,cjs.Ease.get(-1)).to({_off:true},1).wait(7));

	// Символ 21
	this.instance_14 = new lib.Символ21();
	this.instance_14.setTransform(281,-83.2,1,1,0,0,0,44.5,46);
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(29).to({_off:false},0).to({y:49.8},9,cjs.Ease.get(-1)).to({rotation:3.5,x:280.9,y:45.7},3).to({rotation:0,x:281,y:48.8},2).wait(11).to({_off:true},1).wait(110));

	// Символ 24
	this.instance_15 = new lib.Символ24();
	this.instance_15.setTransform(210.9,-84.8,1,1,-1.4,0,0,45,46);
	this.instance_15._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(33).to({_off:false},0).to({y:48.2},9,cjs.Ease.get(-1)).to({rotation:-6.4,y:44.1},3).to({rotation:-1.4,y:47.2},2).to({rotation:-1.4},7).wait(95).to({regY:46.1,rotation:-53.7,y:361.3},10,cjs.Ease.get(-1)).to({_off:true},1).wait(5));

	// Символ 22
	this.instance_16 = new lib.Символ22();
	this.instance_16.setTransform(44.5,-75.2,1,1,0,0,0,44.5,46.5);
	this.instance_16._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(36).to({_off:false},0).to({y:57.8},9,cjs.Ease.get(-1)).to({regX:44.4,rotation:-3.7,y:53.8},3).to({regX:44.5,rotation:0,y:56.8},2).wait(101).to({rotation:35.2,y:370.9},10,cjs.Ease.get(-1)).to({_off:true},1).wait(3));

	// Символ 21
	this.instance_17 = new lib.Символ21();
	this.instance_17.setTransform(124,-83.2,1,1,0,0,0,44.5,46);
	this.instance_17._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(30).to({_off:false},0).to({y:49.8},9,cjs.Ease.get(-1)).to({rotation:3,y:45.8},3).to({rotation:0,y:48.8},2).wait(110).to({rotation:-31,y:362.9},10,cjs.Ease.get(-1)).wait(1));
...
(lib.Символ14 = function() {
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.bf(cjs.SpriteSheetUtils.extractFrame(ss["gonzo_vul640_305_atlas_"],3), null, new cjs.Matrix2D(0.541,0,0,0.541,-78,-108.9)).s().p("");
	this.shape.setTransform(78.1,108.9);

	this.addChild(this.shape,this.instance_2,this.instance_1,this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(32.6,42,91,133.9);
...
(lib.Символ68 = function() {
	...
	this.instance.cache(-2,51,416,420);

	this.addChild(this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,56.5,436.6,440.8);
...
(lib.Символ60 = function() {
	...
	this.instance_3.filters = [new cjs.ColorFilter(0.85, 0.85, 0.85, 1, 15.3, 15.3, 0, 0)];
	this.instance_3.cache(-2,55,441,445);

	this.addChild(this.instance_3,this.instance_2,this.instance_1,this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-34.8,-31.7,436.6,440.8);
...
p.nominalBounds = new cjs.Rectangle(0,0,199.2,185.7);
...
p.nominalBounds = new cjs.Rectangle(-28,1.5,200.1,236.4);
...
(lib.gonzo_vul640305 = function() {
	this.initialize();

	// Слой 2
	this.instance = new lib.Символ70();
	this.instance.setTransform(587.8,32.5,1,1,0,0,0,52.2,35.5);

	// Слой 1
	this.instance_1 = new lib.Символ55();
	this.instance_1.setTransform(320.1,272.4,1.072,1.072,0,0,0,188.5,31.8);
	new cjs.ButtonHelper(this.instance_1, 0, 1, 1);

	this.instance_2 = new lib.Символ47();
	this.instance_2.setTransform(549.3,274.2,0.521,0.528,0,0,180,161.8,75);

	this.instance_3 = new lib.Символ47();
	this.instance_3.setTransform(71.1,273.2,0.702,0.702,0,0,0,161.7,75);

	this.instance_4 = new lib.Символ1();
	this.instance_4.setTransform(534.5,179,1.03,1,0,1.2,-178.8,102.7,118.7);

	this.instance_5 = new lib.Символ1();
	this.instance_5.setTransform(92.9,157.8,1,1,-14.5,0,0,102.7,118.7);

	this.instance_6 = new lib.Символ60();
	this.instance_6.setTransform(317.2,148,1,1,0,0,0,183.7,186.4);

	this.instance_7 = new lib.Символ45();
	this.instance_7.setTransform(313.6,167,0.842,0.802,0,0,0,400.1,257);
...
p.nominalBounds = new cjs.Rectangle(275.5,11.8,713.5,513.8);
