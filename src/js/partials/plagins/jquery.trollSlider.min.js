(function($){
  jQuery.fn.trollSlider = function(options){
        ...
        var trollSlider = {
            ...
            touchScroll:function(slider){
                slider.on('swipeleft',function() {trollSlider.nextSlide();})
                slider.on('swiperight',function() {trollSlider.prevSlide();})
